...
// Fr.o.m version 1.5
        method.invoke(null, new Object[]{constr.newInstance(Integer.valueOf(6)),Integer.valueOf(1000000)});
        System.out.println();
        method.invoke(null, new Object[]{constr.newInstance(Integer.valueOf(4)),Integer.valueOf(1000000)});
// T.o.m version 1.4.2
//        method.invoke(null, new Object[]{constr.newInstance(new Object[]{Integer.valueOf(6)}),Integer.valueOf(1000000)});
//        System.out.println();5
//        method.invoke(null, new Object[]{constr.newInstance(new Object[]{Integer.valueOf(4)}),Integer.valueOf(1000000)});
    }
    ...
    public static void testMethod2() throws Exception {
        ...
        Object dice = constrDice.newInstance(new Object[]{Integer.valueOf(6)});
        Object ordPlayer = constrOP.newInstance(new Object[]{new String("Rut"),dice});
        method.invoke(null, new Object[]{ordPlayer,Integer.valueOf(1000000)});
        System.out.println();
        Object cheater = constrC.newInstance(new Object[]{new String("Fuffe"),dice});
        method.invoke(null, new Object[]{cheater,Integer.valueOf(1000000)});
    }
